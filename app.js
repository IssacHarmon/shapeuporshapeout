...
let recBtn = $("#create-rectangle");
let sqBtn = $("#create-square");
let cirBtn = $("#create-circle");
let triBtn = $("#create-triangle");
...
class Triangle extends Shape {
  ...
  getPerimeter() {
    return (
      2 * this.height +
      Math.pow(Math.pow(this.height, 2) + Math.pow(this.height, 2), 0.5)
    );
  }
  style() {
    $(this.div).css({
